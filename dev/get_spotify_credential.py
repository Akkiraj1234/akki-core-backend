...
class TKList(ctk.CTkScrollableFrame):
    def __init__(self, master, text_style, **kwargs):
        super().__init__(master, **kwargs)
        self.grid_columnconfigure(0, weight=1)
        self.normal_text_style = text_style
        self.items = []
        
    def add_entry(self, placeholder: str = "write spotify aoi"):
        self.entry_widgets = ctk.CTkEntry
    ...
    def add_item(self, text):
        ...
        item.pack(fill="x", padx=2, pady=5)
